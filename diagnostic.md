...
```scss
// your response here  $color-cornflower: #6495ed;
```
...
```scss
// @function tint($color-cornflower, 20%) {
//  @return mix(white, $color-cornflower, 20%);
```
